      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <?php foreach($tb_pasien as $l){
             $query = $this->db->query("select * from tb_ugd where id_pasien = $l->id_pasien")->result();
          ?>
          ...
          <?php }?>
          <div>
            <form action="<?php echo base_url('fo/Rawatugd/tambah') ?>" method="post" enctype="multipart/form-data" role="form" data-parsley-validate="" class="form-horizontal form-label-left">
              <div class="row">
                <div class="form-group">
          ...
          <div>
            <div class="panel-body">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                <div class="col-md-11 col-sm-11 col-xs-12 col-md-offset-11">
                  <a href="<?php echo base_url('fo/Rawatugd') ?>" type="button" class="btn btn-danger">kembali</a>
                </div>
              </div>
            </div>
          </div>
