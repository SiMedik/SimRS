<?php
	...
	public function index()
	{
		...
		$this->load->view('keuangan/view_pjawab',$data);
		$this->load->view('keuangan/view_footer');
	}
	public function tambah(){
		$this->load->view('keuangan/view_header');
		$this->load->view('keuangan/view_tambah_pjawab');
		$this->load->view('keuangan/view_footer');
	}
	...
	public function edit($id_pjawab){
		...
		$this->load->view('keuangan/view_edit_pjawab',$data);
		$this->load->view('keuangan/view_footer');
	}
