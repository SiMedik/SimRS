...
class Pegawai extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('fo/view_pegawai',$data);
	...
	public function tambah(){
		...
		$this->load->view('fo/view_tambah_pegawai',$data);
		$this->load->view('fo/view_footer');
	}
	public function aksi_tambah(){
		...
		$config['upload_path']		= './upload/foto_pegawai/';//penyimpanan
	...
	public function edit($id_pegawai){
		...
		$data['tb_jenjang']	= $this->M_datamaster->tampil_data('tb_jenjang');
		$data['tb_jabatan']	= $this->M_datamaster->tampil_data('tb_jabatan');
		$this->load->view('fo/view_edit_pegawai',$data);
		$this->load->view('fo/view_footer');
	}
