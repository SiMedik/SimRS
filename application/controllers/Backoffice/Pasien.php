<?php
	...
	public function index()
	{
		...
		$this->load->view('Backoffice/view_pasien',$data);
		$this->load->view('Backoffice/view_footer');
	}
	public function tambah(){
		$this->load->view('Backoffice/view_header');
		$this->load->view('Backoffice/view_tambah_pasien');
		$this->load->view('Backoffice/view_footer');
	}
	...
	public function edit($id_pasien){
		...
		$this->load->view('Backoffice/view_edit_pasien',$data);
		$this->load->view('Backoffice/view_footer');
	}
