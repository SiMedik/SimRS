  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <a href="<?php echo base_url()."bo/pegawai/tambah"?>" type="button" class="btn btn-round btn-primary"><i class="fa fa-plus"></i> Tambah</a>
            ...
            <table id="datatable" class="table table-striped table-bordered">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a type="button" class="btn btn-danger" href="<?php echo base_url()."bo/pegawai/edit/".$l->id_pegawai ?>" style="color: #fff"><i class="fa fa-pencil"></i></a>
                      <a type="button" class="btn btn-primary" href="<?php echo base_url()."bo/pegawai/hapus/".$l->id_pegawai ?>" style="color: #fff"><i class="fa fa-trash-o"></i></a>
                  </td>
                </tr>
              <?php }?>
              </tbody>
