            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url()."Backoffice/Dashboard"?>"><i class="fa fa-home"></i> Dashboard</a>
                  </li>
                  <li><a href="<?php echo base_url()."Backoffice/Dokter"?>"><i class="fa fa-user"></i>Dokter </a>
                  <li><a href="<?php echo base_url()."Backoffice/Pasien"?>"><i class="fa fa-user"></i>Pasien </a>
                  <li><a href="<?php echo base_url()."Backoffice/Obat"?>"><i class="fa fa-users"></i>Obat </a>
                  <li><a href="<?php echo base_url()."Backoffice/Apoteker"?>"><i class="fa fa-users"></i>Apoteker </a>
                  </li>
                </ul>
              </div>
            </div>
