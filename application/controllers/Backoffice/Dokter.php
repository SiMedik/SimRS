<?php
	...
	public function index()
	{
		...
		$this->load->view('Backoffice/view_dokter',$data);
		$this->load->view('Backoffice/view_footer');
	}
	public function tambah(){
		$this->load->view('Backoffice/view_header');
		$this->load->view('Backoffice/view_tambah_dokter');
		$this->load->view('Backoffice/view_footer');
	}
	...
	public function edit($id_dokter){
		...
		$this->load->view('Backoffice/view_edit_dokter',$data);
		$this->load->view('Backoffice/view_footer');
	}
